...
NEWS_TOPICS = {
    ...
    "⑤家族ができる高齢者の自己肯定感向上サポート": {
        ...
        "sources": [
            ...
            # ★2026-09-14 追加。★実測で⑤の5クエリが 48h内 0/4/0/1/0件と痩せていた。
            #   ★病気:「(高齢者/シニア)×(自己肯定感/尊厳)×(家族/支援/…)」の3語ANDで
            #     日本語ニュースにその組合せが立たない（"自己肯定感"単独は48h内6件出るが
            #     全部★子育て・受験・自己啓発で高齢者と結びつかない）。
            #   ★叩き比べた候補5本のうち採用したのは「世代間交流・多世代」だけ:
            #     ⑤a 傾聴・声かけ       0件
            #     ⑤b 生きがい・社会参加   3件だが★②と重複3件（同じ「婦人公論・齋藤孝」記事）
            #     ⑤c 世代間交流・多世代  ★2件・②と重複0（採用）
            #     ⑤d 高齢者×孫・家族   0件
            #     ⑤e 認知症×家族の関わり 0件
            #   ★limiter外しの土台のみ。実測: 多世代食堂・高齢者住宅の交流祭り等が拾えた。
            {"type": "google_news",
             "query": '(世代間交流 OR 多世代 OR "子どもと高齢者")'},
        ],
    },
}
